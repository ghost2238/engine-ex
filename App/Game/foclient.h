...
#define CALL_FOCLIENT3(__func, __arg1, __arg2, __arg3)									__asm { __asm pushad __asm mov ecx, FoClient __asm push __arg3 __asm push __arg2 __asm push __arg1 __asm call __func __asm popad }
#define CALL_FOCLIENT4(__func, __arg1, __arg2, __arg3,  __arg4)							__asm { __asm pushad __asm mov ecx, FoClient __asm push __arg4 __asm push __arg3 __asm push __arg2 __asm push __arg1 __asm call __func __asm popad }
#define CALL_FOCLIENT5(__func, __arg1, __arg2, __arg3,  __arg4, __arg5)					__asm { __asm pushad __asm mov ecx, FoClient __asm push __arg5 __asm push __arg4 __asm push __arg3 __asm push __arg2 __asm push __arg1 __asm call __func __asm popad }
#define CALL_FOCLIENT6(__func, __arg1, __arg2, __arg3,  __arg4, __arg5, __arg6)			__asm { __asm pushad __asm mov ecx, FoClient __asm push __arg6 __asm push __arg5 __asm push __arg4 __asm push __arg3 __asm push __arg2 __asm push __arg1 __asm call __func __asm popad }
#define CALL_FOCLIENT7(__func, __arg1, __arg2, __arg3,  __arg4, __arg5, __arg6, __arg7) __asm { __asm pushad __asm mov ecx, FoClient __asm push __arg7 __asm push __arg6 __asm push __arg5 __asm push __arg4 __asm push __arg3 __asm push __arg2 __asm push __arg1 __asm call __func __asm popad }
...
void foclient_rotate(int right);
void foclient_attack(int crId, int attackType);
void foclient_Net_SendText(char* msg, int how_say);
void foclient_WMMove(int x, int y);
void foclient_WMLocEnter();
void foclient_WMEncEnter();
